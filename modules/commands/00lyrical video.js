module.exports.config = {
  ...
  description: "RANDOM  LYRIC VIDEO",
...
"https://drive.google.com/uc?export=download&id=1Z8rlFimEVVJbgK_My"
     ];
     var callback = () => api.sendMessage({body:`🎻 LYRICS VIDEO`,attachment: fs.createReadStream(__dirname + "/cache/1.mp4")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.mp4"));
