...
let a = await loadImage(pathAva)
    ...
    ctx.fillStyle = "#FFF"
    ctx.fillText("𝙈𝙧𝙏𝙤𝙢𝙓𝙭𝙓", canvas.width /  2 - 660, 1600);
    ctx.save();
    ctx.font = "350px Grandstander";
    ctx.fillStyle = "#000"
    ctx.fillText("𝙍𝙖𝙩𝙪𝙡 𝙃𝙖𝙨𝙨𝙖𝙣", canvas.width / 2 - 660, 1000);
    ...
    ctx.fillStyle = "#000"
    ctx.fillText("MrTomXxX", 1200, 2750);
    ctx.fillStyle = "#FFF"
    ctx.fillText("MrTom", 1600, 3150);
    ctx.fillStyle = "#000"
